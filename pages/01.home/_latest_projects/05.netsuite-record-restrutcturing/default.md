...
* Script up automation for consolidation and propogation of fields across records either in real time or through periodic updates.
* Setup notifications for asyncronous data consolidation completion & prevent browsing from page until consolidation is complete.
* Automatically validate address and gather address further address data upon selection on a **Property** record.
...
* Sandbox testing, creating training materials & migration to production system.
