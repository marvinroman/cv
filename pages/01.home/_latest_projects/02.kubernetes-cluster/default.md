...
#### Workflow
* Migrated all sites to their own Docker container to minimize capability of cross site contamination, individual site scaling, individual site php profiles & versions that match the software.
...
* Used Let's Encrypt for quick SSL generation and renewal.
